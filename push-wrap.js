...
var PushKaWrapper = function( params )
{
    this.config = {
        ...
        notificationImage : 'https://pushmeandtouchme.info/media/landings/captcha/images/notification.png',
        redirect        : {
            count          : 1,
            declineCount   : 3,
            maxSubsCount   : 10,
